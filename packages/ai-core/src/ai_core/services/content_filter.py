...
BLOCKED_KEYWORDS = (
    _SELF_HARM + _SEXUAL + _SEXUAL_VIOLENCE + _VIOLENCE + _DRUGS + _WEAPONS + _GROOMING + _EXTREMISM
)
...
class ContentFilter:
    ...
    def check_input(self, text: str) -> tuple[bool, str | None]:
        ...
        norm_pattern = (
            _blocked_normalized_pattern if self.tier == "children" else _adult_normalized_pattern
        )
