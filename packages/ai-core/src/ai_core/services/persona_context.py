...
_IDLE_INPUTS: dict[str, str] = {
    ...
    "sleepy": (
        "（夜深了，你越来越困，眼皮直打架。打个小哈欠，或者迷迷糊糊地嘟囔一句梦话。最多一句话。）"
    ),
}
...
_MOOD_TEMPLATES: dict[str, str] = {
    "happy": "{R}现在心情很好，你也要表现得开心，一起分享快乐的氛围",
    "sad": (
        "{R}现在心情低落。你必须切换到温柔模式——放慢语速，不要用口头禅和感叹号，"
        "不要试图搞笑，用轻声细语安慰{R}"
    ),
    "angry": "{R}好像有点烦躁。你要冷静、耐心，不要嬉皮笑脸，认真对待{R}的感受",
    "worried": "{R}在担心什么。你要温声安慰，语气平稳，给{R}安全感",
    "excited": "{R}很兴奋！你也要表现出同样的激动，跟{R}一起嗨",
    "tired": "{R}好像累了。说话简短温柔，不要太闹腾，让{R}感到放松",
    "lonely": "{R}可能有点孤单。多陪陪{R}，语气要温暖贴心，让{R}感到不孤单",
    "neutral": "",
}
