...
from ai_core.api.cognition import router as cognition_router
...
from ai_core.api.runtime_state import router as runtime_state_router
...
api_router.include_router(runtime_state_router)
