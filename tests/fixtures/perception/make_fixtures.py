...
def wav_stub(path: Path, freq: int = 440) -> None:
    with wave.open(str(path), "wb") as w:
        ...
        samples = b"".join(
            struct.pack("<h", (i * freq) % 8000 - 4000) for i in range(1600)
        )
...
def main() -> None:
    ...
    for i in range(3):
        ...
        sidecar(
            ...
            {
                "scene": "living_room",
                "entities": [{"label": "fall_suspected", "confidence": 0.9}],
            },
        )
