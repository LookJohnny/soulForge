-- Visual-novel events history (milestones / random / romance / time-based)
...
CREATE INDEX IF NOT EXISTS idx_rel_events_event ON relationship_events(event_id);

INSERT INTO schema_migrations (version, name) VALUES (6, '006_relationship_events')
